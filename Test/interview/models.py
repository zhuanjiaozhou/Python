...
class Candidate(models.Model):
    ...
    first_disadvantage = models.TextField(max_length=1024, blank=True, verbose_name=u'顾虑不足')
    first_result =  models.CharField(max_length=256, choices=FIRST_INTERVIEW_RESULT_TYPE, blank=True, verbose_name=u'初始结果')
    ...
    # first_interviewer =models.CharField(max_length=256, blank=True, verbose_name=u'初始官')
    first_remark = models.CharField(max_length=256, blank=True, verbose_name=u'初始备注')

    #第二轮面试
    second_score = models.DecimalField(decimal_places=1, null=True, max_digits=2, blank=True, verbose_name=u'专业复试分', help_text=u'1-5分，极优秀: >=4.5，优秀: 4-4.4，良好: 3.5-3.9，一般: 3-3.4，较差: <3分')
    second_learning_ability = models.DecimalField(decimal_places=1, null=True, max_digits=2, blank=True, verbose_name=u'学习能力得分')
    second_professional_competency = models.DecimalField(decimal_places=1, null=True, max_digits=2, blank=True, verbose_name=u'专业能力得分')
    ...
    second_pressure_socre = models.DecimalField(decimal_places=1, null=True, max_digits=2, blank=True, verbose_name=u'抗压能力得分')
    second_advantage = models.TextField(max_length=1024, blank=True, verbose_name=u'优势')
    second_disadvantage = models.TextField(max_length=1024, blank=True, verbose_name=u'顾虑不足')
    second_result =  models.CharField(max_length=256, choices=FIRST_INTERVIEW_RESULT_TYPE, blank=True, verbose_name=u'专业复试结果')
    second_recommend_position = models.CharField(max_length=256, blank=True, verbose_name=u'建议或推荐部门')
    ...
    hr_poentail= models.CharField(max_length=10, choices=HR_SCORE_TYPE, blank=True, verbose_name=u'HR发展潜力')
    ...
    hr_disadvantage = models.TextField(max_length=1024, blank=True, verbose_name=u'顾虑不足')
    ...
    creator =  models.CharField(max_length=256, blank=True, verbose_name=u'候选人数据创建人')
    create_date = models.DateField(auto_now_add=True, null=True, verbose_name=u'创建时间')
    modified_date = models.DateField(auto_now_add=True, null=True, blank=True, verbose_name=u'更新时间')
    ...
    class Meta:
        ...
        permissions = [
            ...
            ("notify", "notify interviewer for candidate reviewer"),
        ]
