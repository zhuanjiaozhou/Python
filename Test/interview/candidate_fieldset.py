...
default_fieldsets = (
    ...
    ('第二轮面试记录', {'fields': (("second_score"), ("second_learning_ability", "second_professional_competency"),
     ...
     "second_pressure_socre"), "second_advantage", "second_disadvantage", "second_result", "second_recommend_position",
                            "second_interviewer_user", "second_remark",)}),
    ('第三轮面试记录', {'fields': ("hr_score", ("hr_responsibility", "hr_communication_ability", "hr_logic_ability"),
     ("hr_poentail", "hr_stability"), "hr_advantage", "hr_disadvantage", "hr_result", "hr_interviewer_user", "hr_remark",)}),
)
