    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modified_date', models.DateField(auto_created=True, blank=True, null=True, verbose_name='更新时间')),
                ...
                ('test_score_of_general_ablity', models.DecimalField(blank=True, decimal_places=1, max_digits=3, null=True, verbose_name='综合能力测评成绩')),
                ...
                ('first_disadvantage', models.TextField(blank=True, max_length=1024, verbose_name='顾虑不足')),
                ('first_result', models.CharField(blank=True, choices=[('建议复试', '建议复试'), ('待定', '待定'), ('放弃', '放弃')], max_length=256, verbose_name='初始结果')),
                ('first_recommend_position', models.CharField(blank=True, max_length=256, verbose_name='推荐部门')),
                ('first_interviewer', models.CharField(blank=True, max_length=256, verbose_name='初始官')),
                ('first_remark', models.CharField(blank=True, max_length=256, verbose_name='初始备注')),
                ...
                ('second_pressure_socre', models.DecimalField(blank=True, decimal_places=1, max_digits=2, null=True, verbose_name='抗压能力得分')),
                ('second_advantage', models.TextField(blank=True, max_length=1024, verbose_name='优势')),
                ('second_disadvantage', models.TextField(blank=True, max_length=1024, verbose_name='顾虑不足')),
                ('second_result', models.CharField(blank=True, choices=[('建议复试', '建议复试'), ('待定', '待定'), ('放弃', '放弃')], max_length=256, verbose_name='专业复试结果')),
                ('second_recommend_position', models.CharField(blank=True, max_length=256, verbose_name='建议或推荐部门')),
                ...
                ('hr_poentail', models.CharField(blank=True, choices=[('S', 'S'), ('A', 'A'), ('B', 'B'), ('C', 'C')], max_length=10, verbose_name='HR发展潜力')),
                ...
                ('hr_disadvantage', models.TextField(blank=True, max_length=1024, verbose_name='顾虑不足')),
