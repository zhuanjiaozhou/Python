# Generated by Django 4.1 on 2022-08-30 08:03
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('interview', '0002_rename_test_score_of_general_ablity_candidate_test_score_of_general_ability_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='candidate',
            name='second_score',
            field=models.DecimalField(blank=True, decimal_places=1, help_text='1-5分，极优秀: >=4.5，优秀: 4-4.4，良好: 3.5-3.9，一般: 3-3.4，较差: <3分', max_digits=2, null=True, verbose_name='专业复试分'),
        ),
    ]
